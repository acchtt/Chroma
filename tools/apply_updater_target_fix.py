...
path = Path("Chroma.WinUI/Services/UpdateService.cs")
...
helper = r'''    private static string GetRunningApplicationPath()
    {
...
replace_once(
    ...
    helper + """    private static void EnsureInstallDirectoryWritable(string installationDirectory)\n""")
